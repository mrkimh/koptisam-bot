...
# ассортимент коптилен
koptilni = [f'Маленькая - {small_price} грн', f'Маленькая с термометром - {small_price_thermo} грн',
            f'Большая - {big_price} грн', f'Большая с термометром - {big_price_thermo} грн']
